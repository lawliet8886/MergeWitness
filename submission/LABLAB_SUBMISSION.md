...
The repository now separates Bob's exact original probe result from the independently strengthened audit result. The responsive UI and verification integrity checks have also been revised locally. A replacement video records a continuous browser session with live comparison and repair actions, rather than the earlier one-frame-per-second edit. Its local artifact details and validation belong in `media/README.md`; the published URLs and SHA above remain historical readback until the final update is explicitly made and verified.

Local replacement MP4: 150 seconds, 1920×1080, H.264/AAC, SHA-256 `cb7321dc01a6613b8198fb2826b9fe56df2c8b4ec42ad11474848016796ced7a` (10,001,374 bytes). It passed a full decode and visual inspection at the opening comparison, matrix, counterexample, Bob evidence, repaired candidate, second case, and closing frame. **This file and the local text corrections are not yet on the public LabLab submission or GitHub.**
